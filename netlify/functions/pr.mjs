...
export default async (req) => {
  ...
  if (process.env.PANOPTIC_FREE_PR !== "on") {
    return json({ error: "La pull request de correctifs fait partie de l'Audit complet (490 EUR), ou nous l'appliquons pour vous. Voir https://panopticaudit.com/#prix" }, 402);
  }
  let body;
