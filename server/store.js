...
export const store = {
  async create(tenant, { target, repoPath }) {
    const rec = { id: newId(), tenant, target, repoPath: repoPath || null, status: "queued", score: null, summary: null, findings: [], created_at: new Date().toISOString(), progress: [] };
